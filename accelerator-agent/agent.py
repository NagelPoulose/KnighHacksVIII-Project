...
list_agent = LlmAgent(
    ...
    name='list_agent',
    description='List of less than 10 accelerators',
    instruction="""Find the patterns in the list of user requests and see if they are related to the category of tasks listed below. If they are outside
    the scope of the tasks listed, return the collective patterns found in the user requests that aren't related to the accelerators listed below.
    Quickly, and I mean quickly skim these tasks to find a high level pattern, not specific tasks.
    "name","description"
...
classify_agent = LlmAgent(
    model='gemini-2.5-flash',
    name='classify_agent',
    description='Helps classify the list of user requests and see if they are related to the category of excel tasks',
    instruction= """ 
    Now take the list of unqualified user requests from state['list'] find specific patterns from them based on user need. 
""",
    output_key = "classify"
)
...
pattern_agent = LlmAgent(
    model='gemini-2.5-flash',
    name='pattern_agent',
    description='Find user patterns',
    instruction="""Take the list from state['list'] and make a list of top 10 most relevant accelerators that could potentially be added, mimic the style of the list below:

"Extend Your Employee Center to Pro","Prescriptive guidance on extending the Employee Center capabilities to include Pro features"
"Health Assessment - Guided","Understanding of the health of your instance and how it maps to ServiceNow leading practices. Delivery of actionable findings to improve overall platform health."
"Introduction to CMDB: Ingestion","Demonstration of the possibilities and capabilities of automating and standardizing CMDB data entry"
"Introduction to Instance Observer","Guidance on understanding and monitoring performance using Instance Observer."
"Introduction to Instance Readiness Assessment","Guidance on understanding and interpreting instance readiness using the Instance Readiness Assessment (IRA)."
"Jumpstart Your AI Agent Studio","Overview and applied demonstration of AI Agent Studio within the ServiceNow Platform"
"Jumpstart Your AI Agents for CSM","Demonstration of the possibilities and capabilities of AI Agents for Customer Service Management (CSM)"
"Jumpstart Your AI Agents for ITSM","Demonstration of the possibilities and capabilities of AI Agents for IT Service Management (ITSM)"
"Jumpstart Your AI Search","Applied demonstration of AI Search's features and performance. Prescriptive guidance on how to empower your users to find the answers they need when and where they need them."
...
Based on the user requests analysis, provide the top 10 most relevant ServiceLater accelerators that would address the identified patterns and needs, and list the user request numbers as evidence of why you selected these topics""",
    output_key = "final_patterns"
)

inital_agent = SequentialAgent(
    name = "inital_agent",
    sub_agents = (list_agent,classify_agent,pattern_agent),
    description = "Initial agent that helps classify the user requests and see if they are related to the category",
)

root_agent = inital_agent
